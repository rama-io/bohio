...
object PrefKeys {
    ...
    val SYSTEM_BAR_VISIBLE = "system:bar:visible"
    val SYSTEM_PREVENT_ROTATION = "system:prevent_rotation"
    ...
    val APP_THEME_BG_1 = "app:theme:bg_1"
    ...
    val APP_THEME_BUTTON_1_SELECTED = "app:theme:button_1_selected"
    val APP_THEME_BUTTON_2 = "app:theme:button_2"
    ...
    val SETTINGS_SECTION_LANGUAGE = "settings:section:language"
    val SETTINGS_SECTION_THEMES = "settings:section:themes"

    val APP_UI_SCALE = "app:ui_scale"
}