...
object PrefKeys {
    ...
    const val APP_THEME_MEDIA_BACKGROUND = "app:theme:media_background"
    const val APP_THEME_BG_DISPLAY = "app:theme:bg_display"
    ...
    const val APP_THEME_BG_4 = "app:theme:bg_4"
    ...
    const val APP_THEME_SUGGESTION = "app:theme:suggestion"
